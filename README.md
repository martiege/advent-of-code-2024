...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `58.0µs` | `76.9µs` |
| [Day 2](./src/bin/02.rs) | `130.0µs` | `405.9µs` |
| [Day 3](./src/bin/03.rs) | `40.1µs` | `28.2µs` |
| [Day 4](./src/bin/04.rs) | `6.1ms` | `95.6µs` |
| [Day 5](./src/bin/05.rs) | `274.5µs` | `1.3ms` |
| [Day 6](./src/bin/06.rs) | `806.8µs` | `463.2ms` |
| [Day 7](./src/bin/07.rs) | `8.2ms` | `567.5ms` |
| [Day 8](./src/bin/08.rs) | `96.4µs` | `455.4µs` |
| [Day 9](./src/bin/09.rs) | `931.9µs` | `54.5ms` |
| [Day 10](./src/bin/10.rs) | `534.6µs` | `295.9µs` |
| [Day 11](./src/bin/11.rs) | `228.7µs` | `8.5ms` |
| [Day 12](./src/bin/12.rs) | `5.9ms` | `6.0ms` |
| [Day 13](./src/bin/13.rs) | `29.3µs` | `29.2µs` |
